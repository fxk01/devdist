  ...
  export default {
    ...
    methods: {
      ...
      diaLogOpenFuc(str, item) {
        ...
        this.$confirm('', '提示', {
          message: h('div', null, [
            h('div', {style: 'marginBottom:10px; fontSize:16px'}, `客戶【${this.cstNameAccept}】${this.diaLogAcceptText}？`),
            h('div', {style: 'fontSize:12px;'}, '確定後将无法恢复，请谨慎操作！')
          ]),
