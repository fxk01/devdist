    ...
    <div class="container">
        <v-top>
            ...
            <div class="v-top-operation" slot="correlation">
                <el-button class="btn-ec0928" size="mini" icon="el-icon-plus" @click="showScheduleDialog('新建日程')">新建日程</el-button>
            </div>
        </v-top>
        <el-row :gutter="20">
            <el-col :span="18">
        ...
        methods: {
            ...
            getSchedule(date) {
                return new Promise((resolve, reject) => {
                    this.$post('/api/BasicsApi/GetCalendarByMonth', { CurMonth: date })
                    .then((res) => {
