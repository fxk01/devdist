                ...
                <el-table-column label="姓名" align="center">
                    <template slot-scope="scope">
                        <div class="round-table">
                            <span class="text">{{scope.row.Stf_Name}}</span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getAverageData() {
                this.$post('/api/AnalysisApi/GetJiXiaoDataByDir', { DateRangeType: this.timeRange })
                .then((res) => {
            ...
            //获取销售漏斗分析
            getFunnelData() {
                this.$post('/api/WorkSpaceApi/GetFunnelDataByDir', { DateRangeType: this.timeRange })
                .then((res) => {
            ...
            getData() {
                ...
                this.$post('/api/AnalysisApi/GetPageAchieveRankByDir', params)
                .then((res) => {
