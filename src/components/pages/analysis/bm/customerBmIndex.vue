...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //获取新增客户、新增线索、新增公海
            getAddedData() {
                this.$post('/api/AnalysisApi/GetNewCustInfoByDir', { DateRangeType: this.timeRange })
                .then((res) => {
            ...
            getCustomerSourceOptions() {
                this.$post('/api/AnalysisApi/GetCustFromByDir', { DateRangeType: this.timeRange })
                .then((res) => {
            ...
            getCustomerAnnualIncomeOptions() {
                this.$post('/api/AnalysisApi/GetCustIncomeByDir', { DateRangeType: this.timeRange })
                .then((res) => {
            ...
            getCustomerSexOptions() {
                this.$post('/api/AnalysisApi/GetCustSexByDir', { DateRangeType: this.timeRange })
                .then((res) => {
            ...
            getCustomerAgeOptions() {
                this.$post('/api/AnalysisApi/GetCustAgeRangeByDir', { DateRangeType: this.timeRange })
                .then((res) => {
